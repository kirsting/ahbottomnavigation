...
public class AHBottomNavigation extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.AHBottomNavigationBehavior_Params, 0, 0);
        try {
            titleActiveTextSize = a.getDimension(R.styleable.AHBottomNavigationBehavior_Params_textActiveSize, resources.getDimension(R.dimen.bottom_navigation_text_size_active));
            titleInactiveTextSize = a.getDimension(R.styleable.AHBottomNavigationBehavior_Params_textInactiveSize, resources.getDimension(R.dimen.bottom_navigation_text_size_inactive));
        } finally {
            a.recycle();
        }
